...
export SH_BIN="${XDG_LIBEXEC_HOME}/sh"
export SH_SHARE="${XDG_DATA_HOME}/sh"

export PATH=$(${SH_BIN}/paths-helper)
...
export FIGNORE='.fseventsd:.DocumentRevisions-V100:.DocumentRevisions-V100-bad-1:.Spotlight-V100:.TemporaryItems:.Trashes:.terraform:.DS_Store:.localized'
